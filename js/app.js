...
buttonConnect.addEventListener( 'click', function (event) {
...
function updateTable ( state ) {
	...
	// textR.innerText = state.R;
	// textG.innerText = state.G;
	// textB.innerText = state.B;
	R = state.R;
	G = state.G;
	B = state.B;

	// color_1.style.background = `rgb(${R}, ${G}, ${B})`;
